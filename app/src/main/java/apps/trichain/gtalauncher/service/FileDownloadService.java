...
public class FileDownloadService extends IntentService {
    ...
    private static final String DOWNLOAD_PROGRESS2 = "download_progress2";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            Log.e(TAG, "onHandleIntent: Received URL: " + url);
            ...
            while ((count = input.read(data)) != -1) {
                ...
                sendProgress(lengthOfFile, progress, resultReceiver);
    ...
    public void sendProgress(int lengthOfFile, int progress, ResultReceiver receiver) {

        Bundle progressBundle = new Bundle();
        progressBundle.putInt(FileDownloadService.DOWNLOAD_PROGRESS, progress);
        progressBundle.putInt(FileDownloadService.DOWNLOAD_PROGRESS2, lengthOfFile);
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == FileDownloadService.STATUS_OK) {
                ...
                if (resultData.containsKey(FileDownloadService.DOWNLOAD_STARTED)
                    ...
                    int lengthOfFile = resultData.getInt(FileDownloadService.DOWNLOAD_PROGRESS2);
                    onDownloadStatusListener.onDownloadProgress(lengthOfFile, progress);
    ...
    public static interface OnDownloadStatusListener {
        ...
        void onDownloadProgress(int lengthOfFile, int progress);
